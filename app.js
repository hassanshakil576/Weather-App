...
//e53a44f74a304b26bed120934241811
...
//                   <div = class = "country">
//                   ${res.location.name}, ${res.location.country} <br>
//                   </div>
//                   <div class = "feels-like">
//                   Feels like:${res.current.feelslike_c}
//                   </div>
//                   <div class = "img-div">
//                   <img src="${res.current.condition.icon}" alt=""><br>
//                   </div>
//                   Temperture: ${res.current.temp_c}<sup>o</sup>C <br>
